...
bot.command(
    "register",
    (ctx) => ctx.reply("Для начала процесса регистрации, пожалуйста, ознакомьтесь с правилами общения и использования нашего бота:\n" + 
...
"Если вы согласны с правилами, то нажмите кнопку"+ "Я принимаю"+"."",{ reply_markup: keyboard }),
);
